...
def _ensure_etl_data() -> Iterator[None]:
    ...
    Earlier unit tests may have TRUNCATEd the table; we transparently
    re-populate so the e2e module is self-contained. No-op when PG is
    down or data is already present.
    """
