...
# =============================================================================
# p02565 港股退市股票一览 (原始字段映射)
# =============================================================================
# THS_DR('p02565') 返回的原始字段 → 语义列名
# 字段含义基于 iFinD 数据浏览器 + 首次运行返回数据确认
# 注: jydm / jydm_mc 是 THS_DR 报表的通用列 (交易代码 / 交易代码名称)
P02565_DELISTED = {
    "jydm": "stock_code",                  # 交易代码 (如 0023.HK)
    "jydm_mc": "company_name",             # 公司简称 (如 G.A.控股)
    "p02565_f001": "company_name_full_zh",  # 公司全称中文 (如 G.A.控股有限公司)
    "p02565_f002": "company_name_full_en",  # 公司全称英文 (如 G.A.Holdings Ltd.)
    "p02565_f003": "delisting_date",       # ★ 退市日期 (如 2026/05/05)
    "p02565_f004": "listing_date",         # 上市日期 (如 2002/06/17)
    "p02565_f009": "delisting_reason",     # ★ 退市原因 (私有化/被取消上市地位/转板/...)
    "p02565_f010": "total_market_cap",     # 退市前总市值 (亿)
    "p02565_f011": "remark",              # 退市备注/详细说明
    "p02565_f005": "registration_place",   # 注册地 (如 开曼群岛)
    "p02565_f006": "office_address",       # 办公地址
    "p02565_f007": "industry",             # 行业分类
    "p02565_f008": "sub_industry",         # 子行业分类
}

# =============================================================================
# 退市/收购 (反幸存者偏差) — load_to_db 消费接口
# =============================================================================
# delisted_pull.py 输出的语义化 CSV 列名, load_to_db.load_delisted() 使用
DELISTED_HK = {
